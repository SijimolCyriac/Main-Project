...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 07, 2021 at 03:21 PM
...
(1, '2021-06-04', '2021-06-06', 1, 4, 'fever', 0);
...
--
ALTER TABLE `tbl_attnd`
  MODIFY `attnd_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tbl_daily_wages`
  MODIFY `wageid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
