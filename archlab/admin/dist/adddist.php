...
<html lang="en">
	...
	<br><br>
															...
															<h3><center>Add District</center></h3>
															</div>
															<div class="card-body" style="background:lightgreen">
															<form action="adddistadm.php" method="POST">
 ...
 <span class="input-group-text"><i class="fa fa-map-marker"></i></span>
															...
															<input type="text" name="dist" class="form-control" placeholder="Enter District Name" id="name1" onblur="validate()" required>
															</div>
			  ...
			  {
			  alert("Please enter district name correctly");
