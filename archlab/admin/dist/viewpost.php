...
if(!empty($_SESSION['uname']))
{
	...
	{
		$a=intval($_GET['x']);
		$sql="update tbl_postoff set status='1' where pid='$a'";
	...
	{
		$a=intval($_GET['y']);
		$sql="update tbl_postoff set status='0' where pid='$a'";
		mysqli_query($con,$sql);
...
$count=1;
                            ...
                            echo "<td>".$count."</td><td>"
                            	       .$fin['post_office']."</td><td>";
																		 ...
																		 ?>
																		 <div id="UpdateLocation<?php echo $fin['pid']; ?>" class="modal fade" role="dialog">
										<div class="modal-dialog">

											<!-- Modal content-->
											<div class="modal-content" style="width: 130%">
												<div class="modal-header"><h3>Modify Post Office</h3>
									...
									alert("Post Office Has Been Updated Successfully!.");
                          ...
                          echo "</tr>";$count++;
                             ...
                             ?>
												...
												<div class="modal-dialog">
													...
													<!-- Modal content-->
													<div class="modal-content" style="width: 130%">
														<div class="modal-header"><h3>Add New Post Office</h3>
															<button type="button" class="close" data-dismiss="modal">&times;</button>
														</div>
														<div class="modal-body">
												...
												$query = "insert into tbl_postoff(post_office,status) values('$address','$status')";
													...
													?>
													<script type="text/javascript">
												alert("New Post Office Has Been Added Successfully!.");
												window.location = "viewpost.php";
												</script>
												<?php
											}}
