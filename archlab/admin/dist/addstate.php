...
<html lang="en">
	...
	<br><br>
															...
															<h3><center>Add State</center></h3>
															</div>
															<div class="card-body" style="background:lightgreen">
															<form action="addstateadm.php" method="POST">
															<div class="input-group form-group">
															<div class="input-group-prepend">
																  <span class="input-group-text"><i class="fa fa-map-marker"></i></span>
															</div>
															<input type="text" name="state" class="form-control" placeholder="Enter state name" id="name1" onblur="validate()" required>
															</div>
