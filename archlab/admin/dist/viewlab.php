...
if(!empty($_SESSION['uname']))
{
	...
	{
		$a=intval($_GET['x']);
		$sql="update tbl_labours_reg set status='1' where login_id='$a'";
	...
	{
		$a=intval($_GET['y']);
		$sql="update tbl_labours_reg set status='0' where login_id='$a'";
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            ...
                            $results = mysqli_query($con,$query);
													  ...
													  echo "<tr><th>Sl No</th><th>Labour Name</th><th>Phone No</th><th>Email Id</th><th>District Name</th><th>State Name</th><th>Aadhar Card</th><th>Aadhar No</th><th>Category Name</th><th>Status</th></tr>";
													  while($fin=mysqli_fetch_array($results))
													  {
													  echo "<tr>";
													  echo "<td>".$fin['lid']."</td><td>"
														     .$fin['labour_name']."</td><td>"
													       .$fin['phoneno']."</td><td>"
													     .$fin['email_id']."</td><td>"
															    .$fin['dist_name']."</td><td>"
													     .$fin['state_name']."</td><td>";
															 echo "<a href='viewaadhar.php?x=" .$fin['login_id']." ' target='_blank'>aadharcard details</a></td><td>"
															 .$fin['adhar_no']."</td><td>"
													   .$fin['category_name']."</td><td>";
														 if($fin['status'] == 0 || $fin['status'] =='')
														{

															echo "<a href='viewlab.php?x=" .$fin['login_id']." '>deactivated</a>";
															}
															else
															 {
																 echo "<a href='viewlab.php?y=" .$fin['login_id']." '>activated</a>
																 </td>";
															 }
													echo "</tr>";
													  }
