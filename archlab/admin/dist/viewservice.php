...
if(!empty($_SESSION['uname']))
{
	...
	{
		$a=intval($_GET['x']);
		$sql="update tbl_services set status='1' where serv_id='$a'";
	...
	{
		$a=intval($_GET['y']);
		$sql="update tbl_services set status='0' where serv_id='$a'";
		mysqli_query($con,$sql);
	}
	?>
<!DOCTYPE html>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            ...
                            {
                            echo "<tr>";
                            echo "<td>".$fin['serv_id']."</td><td>"
                            	       .$fin['service']."</td><td>";
																		 echo '<a href="#" class="btn btn-sm btn-info" data-toggle="modal"
																		 data-target="#UpdateServices'.$fin['serv_id'].'">edit</a></td><td>';
			                               ?>
			                               <div id="UpdateServices<?php echo $fin['serv_id']; ?>" class="modal fade" role="dialog">
			              <div class="modal-dialog">

			                <!-- Modal content-->
			                <div class="modal-content" style="width: 130%">
			                  <div class="modal-header"><h3>Modify Service</h3>
...
{
									$query = "update tbl_services set service='$address' where serv_id='$id'";
									...
									<?php
			                             	 ...
			                             	 {
			                             		 echo "<a href='viewservice.php?x=" .$fin['serv_id']." '>inactive</a>";
			                             	 }
			                             		 else
			                             	 {
			                             				echo "<a href='viewservice.php?y=" .$fin['serv_id']." '>active</a>
			                             				</td>";
			                             	 }
                          echo "</tr>";
                            }
                             ?>
												...
												<div class="modal-dialog">
													...
													<!-- Modal content-->
													<div class="modal-content" style="width: 130%">
														<div class="modal-header"><h3>Add New Service</h3>
															<button type="button" class="close" data-dismiss="modal">&times;</button>
														</div>
														<div class="modal-body">


																		<form method="POST" action="addser1.php">
																			<div class="form-group">
