...
<html lang="en">
	...
	<div class="form-body">
															<form action="addcatadm.php" method="POST">
																<div class="form-group"> <label for="exampleInputEmail1">Category Name</label> <input type="text" name="item" class="form-control" placeholder="Enter category name" id="name1" onblur="validate()"  required='true'> </div>


																 <input type="submit" value="Add" class="btn btn-success">&emsp;<input type="reset" value="Cancel" class="btn btn-success"> </form>
															</div>
															</div>
															</div>
