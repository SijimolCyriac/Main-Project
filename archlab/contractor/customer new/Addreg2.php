...
$sq="insert into tbl_contractor_reg(login_id,contractor_name,email_id,phone_no,licenseNo,licenseProof,companyName,dist_name,state_name,status) values('$n','$contractor_name','$email_id','$phone_no','$licenseNo','$licenseProof','$companyName','$dist_name','$state_name','$status')";
