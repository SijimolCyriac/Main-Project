                    ...
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
														...
														<li class="breadcrumb-item active"><a href="contrareg1.php">Edit Profile</a></li>
                        </ol>
                          ...
                          <div class="input-group-prepend">
                            ...
                            <input type="tel" class="form-control" value="<?php echo $result['phone_no']; ?>" name="phn" id="phno" placeholder="Phone Number" onblur="validate2()" required/>
													...
													<div class="input-group-prepend">
														...
														<input type="tel" class="form-control" value="<?php echo $result['licenseNo']; ?>" name="lic" id="lno"  required/>
													            ...
													            <input type="text" class="form-control" value="<?php echo $result['companyName']; ?>" name="compname" id="compname1" placeholder="Company Name" onblur="validate6()" required/>
													            </div>
