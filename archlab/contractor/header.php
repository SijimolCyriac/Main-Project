...
<form method="POST" action="Addreg1.php" enctype="multipart/form-data">
<?php
include("DbConne.php");
...
<input type="text" id="name1" class="form-control"  name="name" id="name1" autofocus="autofocus" required  placeholder="Enter Full Name"  onblur="validate()" value="<?php echo $result['contractor_name']; ?>">
    <br><label for="exampleInputEmail1">Phone Number</label>
    <input type="tel" id="phno" class="form-control"  name="phn" id="phno" autofocus="autofocus" required  onblur="validate2()" placeholder="Enter Phone Number" value="<?php echo $result['phone_no']; ?>">
