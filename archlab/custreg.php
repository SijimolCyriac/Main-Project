        ...
        <div id="layoutAuthentication">
            ...
            <form action="Addreg1.php" name="tf" method="POST">
              <div class="form-group">
                  ...
                  <input class="form-control py-4" name="name" id="name1" type="text" placeholder="Enter Full Name" onblur="validate()" required/>
              </div>

              <div class="form-group">
                  <label class="small mb-1" for="inputFirstName">Home Address</label>
                  <input type="text" class="form-control py-4" name="address" id="address1" placeholder="Enter Home Address" onblur="validate6()"  required/>
            </div>
            <div class="form-row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="small mb-1" for="inputFirstName">Post Office</label>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="small mb-1" for="inputLastName">Pin Code</label>
                        <input type="postal" class="form-control py-4" name="pincode" id="pincode1" placeholder="Enter Pin Code" onblur="validate7()" required/>
                    </div>
                </div>
            </div>
            ...
            <input type="tel" class="form-control py-4" name="phn" id="phno" placeholder="Enter Phone Number" onblur="validate2()" required/>
            </div>


            <div class="form-group">
                <label class="small mb-1" for="inputFirstName">Email Address</label>
            <input type="text" class="form-control py-4" name="email" id="email1" placeholder="Enter Email Address" onblur="checkAvailability2()"  required/>
            </div>
            ...
            <input type="text" class="form-control py-4"   name="uname" id="uname1" placeholder="Create Username" onBlur="checkAvailability()">
            </div>
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">BuildTech Construction Management System</h2>
...
function check() {
      var em = document.getElementById('email1').value;
            ...
            ajax.open("GET", "getemail.php?email="+em, true);
            ajax.send();

}

function check1() {
    var un = document.getElementById('uname1').value;
          if (!un) return;
          console.log("WORKING user TILL HERE");
          var ajax = new XMLHttpRequest();
          console.log("hello");
          ...
          ajax.open("GET", "getuname.php?uname="+un, true);
          ajax.send();
