      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
            ...
            <h3><center><b>Customer Registration Form</b></center></h3>
            </div>
            ...
            <input type="text" class="form-control" name="address" id="address1" placeholder="Home Address" onblur="validate6()"  required/>
            </div>
            ...
            <div class="input-group-prepend">
              ...
              <input type="postal" class="form-control" name="pincode" id="pincode1" placeholder="Pin Code" onblur="validate7()" required/>
            ...
            <input type="text" class="form-control" name="email" id="email1" placeholder="Email Address" onblur="checkAvailability2()"  required/>
            </div>
            ...
            <input type="text" class="form-control"   name="uname" id="uname1" placeholder="Create Username" onBlur="checkAvailability()">
            </div>
