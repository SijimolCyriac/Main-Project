      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
            ...
            <h3><center><b>Contractor Registration Form</b></center></h3>
            <center><p>Register As:
            &nbsp;&nbsp;<a href="custreg.php"><input type="radio" name="color" id="r1" /><label for="r1">Customer</label></a>
            &nbsp;&nbsp;<a href="contrareg.php"><input type="radio" name="color" id="r2" checked="checked"/><label for="r2">Contractor</label></a>
            &nbsp;&nbsp;<a href="labreg.php"><input type="radio" name="color" id="r3" /><label for="r3">Labour</label></a></p></center>
            </div>
            ...
            <input type="text" class="form-control" name="email" id="email1" placeholder="Email Address" onblur="checkAvailability3()" required/>
            ...
            <div class="input-group-prepend">
              ...
              <input type="tel" class="form-control" name="licenseno" id="license" placeholder="License Number" onblur="validate5()" required/>
            </div>
            ...
            <input type="text" class="form-control" name="compname" id="compname1" placeholder="Company Name" onblur="validate6()" required/>
            </div>
            ...
            <input type="text" class="form-control" name="uname" id="uname1" placeholder="Create Username" onblur="checkAvailability1()" required/>
