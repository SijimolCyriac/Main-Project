	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container-fluid">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item active"><a href="login.html" class="nav-link">Sign In</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
				...
				<div class="row">
					<div class="col-lg-7 order-md-last d-md-flex align-items-stretch">
						...
						<div class="img w-100 img-2 img-overlay ml-md-2 p-4" style="background-image: url(images/about-2.jpg);">
	    					...
	    					<form action="Addlogin.php" method="post" class="request-form ftco-animate">
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">BuilTech Construction</h2>
