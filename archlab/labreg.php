    ...
    <section class="ftco-section contact-section" style="background-image: url('images/bg_2.jpg');" data-stellar-background-ratio="0.5">
      <div id="layoutAuthentication">
          ...
          <div class="container">
            ...
            <input type="text" class="form-control py-4" name="email" id="email1" placeholder="Email Address" onblur="checkAvailability5()" required/>
            </div>
          ...
          <div class="form-group">
            <label class="small mb-1" for="inputFirstName">Aadharcard Proof</label>
            ...
            <div class="form-row">
                <div class="col-md-6">
            <div class="form-group">
              <label class="small mb-1" for="inputFirstName">Aadharcard Number</label>
            <input type="tel" class="form-control py-4" name="card" id="card1"  placeholder="AdharCard Number"  onblur="validate5()" required/>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control py-4" name="uname" id="uname1" placeholder="Create Username" onblur="checkAvailability4()"  required/>
            </div>
...
<label class="small mb-1" for="inputFirstName">Confirm Password</label>
  ...
  if(!adnum.match(num))
  {
  alert("Enter 12 Digit Valid Adharcard Number Eg: 235689451245");
